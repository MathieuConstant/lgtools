...
public class ArcStandardTransitionBasedParserModel extends
	...
	private final String SHIFT = "SH";
	private final String LEFT_ARC = "LA";
	private final String RIGHT_ARC = "RA";
	...
	private String getLeftArcLabel(Configuration<DepTree> configuration){
	...
	private String getRightArcLabel(Configuration<DepTree> configuration){
		Deque<Unit> stack = configuration.getFirstStack();
		if(stack.size() >= 2){
			Unit u1 = stack.pop();
			Unit u2 = stack.peek();
